...
<div class="container">
      ...
      <div  class="form">
    		<form:form id="contactform" action="addStudent.html" method="POST" modelAttribute="Student"> 
    			...
    			<form:input path="motherFirstName" placeholder="Mother First Name" data-validation="custom" data-validation-regexp="^(A-Z[a-z\s]+)$" data-validation-error-msg = "Enter alphabets only" required = "required" tabindex="1" type="text"/>
